...
# File Name:    ahmed.sh
# Description:  Add ahmed user, get public key from github.  Allow passwordless sudo.
# Version:      1
# Author:       ricky beaty
# Date:         09/06/25
...
USERNAME="ahmed"
GECOS="syed ahmed,NA,NA,NA"
SSH_KEYS_URL="https://github.com/syedahmedmansoor.keys"
