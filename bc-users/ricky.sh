...
# File Name:    ricky.sh
# Description:  Add ricky user, get public key from github.  Allow passwordless sudo.
# Version:      1
# Author:       Ricky Beaty
# Date:         09/06/25
...
USERNAME="ricky"
GECOS="Ricky Beaty,NA,NA,NA"
SSH_KEYS_URL="https://github.com/beatyconsultancy.keys"
